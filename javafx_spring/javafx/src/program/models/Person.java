...
public class Person implements JSONSerialize {
    ...
    public Person(String firstName, String lastName, String city, String street, Integer postalCode, LocalDate birthday, Integer id) {
    ...
    public String toJson() {
        ...
        map.put("postalCode", String.valueOf(postalCode));
